      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href=""><img src="images/003-united-states.png" alt="English" title="EN">EN</a>
          </div>
        </li>
      </ul>
    </div>
...
<div class="modal-dialog text-center">
  <div class="col-sm-12 main-section">
    <div class="modal-content">
      ...
      <div>
        <label for="login" class="text-light">already have account ? <button id="login" class="btn btn-danger" data-toggle="modal" data-target="#loginModal">Login</button></label>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" class="form-control m-2" placeholder="Username or Email">
        <input type="password" class="form-control m-2" placeholder="Password">
        <label class="" for=""><a class="" href="">forget password ?</a></label>
      </div>
...
<footer class="bg-dark">
  <span class="text-light">all right reserver Bloogy &copy;</span>
</footer>
<!-- Optional JavaScript -->
